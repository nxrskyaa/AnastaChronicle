export const ITEMS = {
  ...
  scepter: { name: "Dawn Scepter", glyph: "+", weapon: true },
  greatblade: { name: "Reaver Greatblade", glyph: "/", weapon: true },
  crossbow: { name: "Wildwood Crossbow", glyph: "}", weapon: true },
...
export const RECIPES = [
  ...
  { id: "scepter", result: "scepter", need: { wood: 4, ore: 2, herb: 3 }, desc: "Radiant focus for guided bolts, healing rites, and protective wards.", group: "Class Weapons", classId: "priest", tier: 2 },
  { id: "greatblade", result: "greatblade", need: { wood: 2, ore: 7, gel: 2 }, desc: "Heavy execution blade forged for committed close-range burst.", group: "Class Weapons", classId: "slayer", tier: 2 },
  { id: "crossbow", result: "crossbow", need: { wood: 6, ore: 3, gel: 1 }, desc: "Fast hunting rig with guided bolts and reliable control at range.", group: "Class Weapons", classId: "hunter", tier: 2 },
