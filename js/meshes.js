...
export function createPalette(isMobile, tex) {
  ...
  return {
    ...
    grassMap,
    pathMap,
    grass: std(0xc5e0b8, grassMap, { roughness: 0.98, flat: false }),
    path: std(0xf0e0c0, pathMap, { roughness: 0.9, flat: false }),
    ...
    leafA: toon(0x5aaa68, leafMap, {}, gmap),
    leafB: toon(0x48a058, leafMap, {}, gmap),
    leafC: toon(0x6aba72, leafMap, {}, gmap),
    leafDark: toon(0x3a7850, leafMap, {}, gmap),
