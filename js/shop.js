...
export const SHOP_CATALOG = Object.freeze([
  ...
  listing({ id: "scepter", name: "Dawn Scepter", description: "A sunlit focus forged for Priest rites and radiant wards.", category: "equipment", iconKey: "item/scepter", sellPrice: 54, unlockLevel: 3, tags: ["weapon", "priest", "crafted"] }),
  listing({ id: "greatblade", name: "Reaver Greatblade", description: "A brutal two-handed edge built for Slayer execution chains.", category: "equipment", iconKey: "item/greatblade", sellPrice: 58, unlockLevel: 3, tags: ["weapon", "slayer", "crafted"] }),
  listing({ id: "crossbow", name: "Wildwood Crossbow", description: "A compact hunting rig tuned for traps and piercing bolts.", category: "equipment", iconKey: "item/crossbow", sellPrice: 50, unlockLevel: 3, tags: ["weapon", "hunter", "crafted"] }),
