...
export const NPC_DEFS = [
  ...
  { name: "Angler",    role: "Fisher",   look: { skin: "#d89b6e", hair: "#4a6ea0", shirt: "#2b8a7a", pants: "#42486a", boots: "#3a3a42", style: "ponytail" }, dx: 192, dy: -120, face: "right", line: "Interact at the water's edge, then choose Manual Fishing or leave an Auto Fishing watch." },
